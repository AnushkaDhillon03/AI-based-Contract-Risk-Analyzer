...
class SummaryGenerator:
    ...
    def _generate_llm_summary(self,clauses):
        ...
        print(
            "\n[INFO] Structured Input Sent To LLM"
        )
    ...
    1. Mention the major clause categories.
    2. Mention critical high-risk findings.
    3. Mention notable medium-risk findings if present.
    4. Provide a brief overall assessment.
    5. Keep the summary under 120 words.
    6. Use paragraph format only.
    7. No headings.
    8. No bullets.
    9. No markdown.
    10. No assumptions.
    ...
    """
        ...
        print(
            "\n[INFO] Response Received From Ollama"
        )
